# produce final plots comparing certain sets of electron isolation variables
...
compare_sets = [['etcone20', 'etcone20_final', 'topoetcone20_final']]#, ['topoetcone20_final', 'topoetcone40_final'], ['ptcone20_final']]

plots = ['cut_scan_%s_pt', 'histo_%s', 'histo_%s_vs_nvx_pfx']
plotopts = [plotoptions(0, 'electron isolation/p_{T} cut', 'efficiency', 0, 0.5), plotoptions(1, 'electron isolation [MeV]', 'entries'), plotoptions(0, 'number of vertices with #geq 2 tracks', 'average electron isolation [MeV]', 0, 30)]


filename = 'output_electron_topoiso.root'
