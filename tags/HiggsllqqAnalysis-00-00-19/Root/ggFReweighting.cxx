...
//using namespace std;
ggFReweighting::ggFReweighting(std::string generator, int higgsMass, std::string option, std::string inputFilePath, std::string mc)
{
   _inputFilePath = inputFilePath;
   initialize(generator, higgsMass, option, mc);
}
...
void ggFReweighting::initialize(std::string generator, int higgsMass, std::string option, std::string mc)
{
   ...
   if (mc == "mc11") {
      _input = "ggFHiggsPtWeight_mc11.root";
      ...
      _errMass.push_back(700);
      _errMass.push_back(800);
      _errMass.push_back(900);
   } else {
      _input = "ggFHiggsPtWeight_mc10.root";
      _errMass.push_back(120);
      _errMass.push_back(130);
      _errMass.push_back(160);
      _errMass.push_back(200);
...
void ggFReweighting::printInfo()
{
   ...
   std::cout << " Available error points (scale and pdf): [ ";
   for (unsigned int i = 0; i < _errMass.size() - 1; i++) {
      std::cout << _errMass[i] << ", ";
   }
   std::cout << _errMass[_errMass.size() - 1] << " ] GeV" << std::endl;
   std::cout << std::endl;
}
...
void initializeHiggsMassLib(std::set<int> &higgsMassLib, std::string generator, std::string input)
{
   ...
   int powheg_mass[] =  {100, 105, 110, 115, 120, 125, 130, 135, 140, 145, 150, 155,
                         ...
                         420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 650, 700, 750, 800, 850, 900
                        };
   ...
   if (generator == "PowHeg") {
      for (i = 0; i < 48; i++) higgsMassLib.insert(powheg_mass[i]);
   }
