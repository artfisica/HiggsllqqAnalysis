...
cp /afs/cern.ch/work/v/vippolit/yield_2012/data_candidates.root no_constraint_no100gevcut/MC_only
cp /afs/cern.ch/work/v/vippolit/yield_2012/data_candidates.root with_constraint/MC_only
cp /afs/cern.ch/work/v/vippolit/yield_2012/data_candidates.root no_constraint/MC_only

echo "running yield estimator for the MC estimate..."
python Higgs4lepAnalysis/python/yield_estimator/yield_estimator.py -d no_constraint_no100gevcut/MC_only &> no_constraint_no100gevcut/MC_only/YIELD &
python Higgs4lepAnalysis/python/yield_estimator/yield_estimator.py -d with_constraint/MC_only -c -l  &> with_constraint/MC_only/YIELD &
python Higgs4lepAnalysis/python/yield_estimator/yield_estimator.py -d no_constraint/MC_only -l &> no_constraint/MC_only/YIELD &
...
cp /afs/cern.ch/work/v/vippolit/yield_2012/histos_*ZZSmooth_SR_2012.root no_constraint_no100gevcut/MC_only
cp /afs/cern.ch/work/v/vippolit/yield_2012/histos_*ZZSmooth_SR_2012.root no_constraint/MC_only
cp /afs/cern.ch/work/v/vippolit/yield_2012/histos_*ZZSmooth_SR_2012.root with_constraint/MC_only
...
python Higgs4lepAnalysis/python/yield_estimator/replace_histos_and_yields.py -i no_constraint_no100gevcut/MC_only -o no_constraint_no100gevcut/data_driven &> no_constraint_no100gevcut/data_driven/NEW_YIELDS &
python Higgs4lepAnalysis/python/yield_estimator/replace_histos_and_yields.py -l -i no_constraint/MC_only -o no_constraint/data_driven &> no_constraint/data_driven/NEW_YIELDS &
python Higgs4lepAnalysis/python/yield_estimator/replace_histos_and_yields.py -l -i with_constraint/MC_only -o with_constraint/data_driven &> with_constraint/data_driven/NEW_YIELDS &
